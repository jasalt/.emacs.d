...
;; TODO C-M-x eval-defun style send-phel-defn-to-process

(defun send-phel-region-or-buffer-to-process (arg &optional beg end)
  ...
  has an active process. -- https://emacs.stackexchange.com/a/37889/42614"
  (interactive "P\nr")
